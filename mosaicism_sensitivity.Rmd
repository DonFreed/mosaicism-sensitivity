...
```{r setupAnalysis, echo=FALSE}
if (!file.exists("~/Downloads/120x_denovo_cut.txt")) {
  download.file("http://gist.githubusercontent.com/DonFreed/329b77aeba3bd1ee9fb1a85741ceeb20/raw/61bcb0a4538b9aebc3d16be771f5a20a8b848875/120x_denovo_cut.txt", "~/Downloads/120x_denovo_cut.txt")
}
```
